...
angular.module('medimage').service('modalsService', ['$uibModal', function ($uibModal) {
  ...
  this.showBinaryModal = function (apply, cancel, binaryParams) {
    var modalInstance = $uibModal.open({
      animation: true,
      templateUrl: 'scripts/modals/binary/modalBinaryTemplate.html',
  ...
  this.showBlurModal = function (apply, cancel, blurParams) {
    var modalInstance = $uibModal.open({
      animation: true,
      templateUrl: 'scripts/modals/blur/modalBlurTemplate.html',
  ...
  this.showHistogramEqualizeModal = function (apply, cancel, equalizeParams) {
    var modalInstance = $uibModal.open({
      animation: true,
      templateUrl: 'scripts/modals/histogramEqualize/modalHistogramEqualizeTemplate.html',
  ...
  this.showCannyModal = function (apply, cancel, cannyParams) {
    var modalInstance = $uibModal.open({
      animation: true,
      templateUrl: 'scripts/modals/canny/modalCannyTemplate.html',
  ...
  this.showChainModal = function (apply, cancel) {
    var modalInstance = $uibModal.open({
      animation: true,
      templateUrl: 'scripts/modals/chain/modalChainTemplate.html',
  ...
  this.showRecognizeModal = function (apply, cancel) {
    var modalInstance = $uibModal.open({
      animation: true,
      templateUrl: 'scripts/modals/recognize/modalRecognizeTemplate.html',
  ...
  this.showErrorModal = function (apply, error) {
    var modalInstance = $uibModal.open({
      ...
      templateUrl: 'scripts/modals/error/modalErrorTemplate.html',
  ...
  this.showSuccessModal = function (apply, success) {
    var modalInstance = $uibModal.open({
      ...
      templateUrl: 'scripts/modals/success/modalSuccessTemplate.html',
